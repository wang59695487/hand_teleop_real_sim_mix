...
class BCSSAgent(object):
    ...
    def init_bc_scheduler(self, T_0, T_mult):
        self.bc_module_scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer=self.bc_module_optimizer, T_0 = T_0, T_mult= T_mult, eta_min=0, verbose=False)
